...
Training a Million parameter language model on AWS Habana EC2 instance with Gaudi Accelerator, which can help people in war zone to reduce their mental issues.
## Inspiration
